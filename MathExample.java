class MathExample{
	public static void main(String args[]){
		...
		System.out.println("rint(): "+Math.rint(1.7));
		...
		System.out.println("floor(): "+ Math.floor(1.58));
		...
		System.out.println("getExponent(): " + 			Math.getExponent( 7.38905609893065));
	...
	System.out.println("IEEEremainder(): " + Math.IEEEremainder(10,8));

	//nextAfter() returns the floating point value adjacent to parameter in the direction to the parameter 2
	System.out.println("nextAfter(): "+ Math.nextAfter(3,1));
